...
<head>
    <meta charset="UTF-8">
    <title>Title</title>
    <link rel="stylesheet"  href="stylewebcss">
</head>
<body>
<br>
<form>
    <fieldset >
        ...
        <br>
        <br>
        <button type="submit" class="btn btn-primary" onclick="<%%>">Új játék</button>
        <br>
        <br>
...
<table class = "board">
    <tr>
        <td><button class="gamecell" type="button" onclick="<%%>"></button></td>
